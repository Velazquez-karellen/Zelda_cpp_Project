...
public:
    ...
    shared_ptr<DynamicEntityAnimations> BlueDarkNutAnimations;
    shared_ptr<DynamicEntityAnimations> magictektikeAnimations;
    ...
    shared_ptr<DynamicEntityAnimations> getRedDarkNutAnimations();
     shared_ptr<DynamicEntityAnimations> getMagicTektikeAnimations();
